...
-- For our purposes right now, it does not matter whether you are familiar
-- with the modules referenced in the import list. Look at the
...
-- R: Data.Bits, Database.Blacktip.Types


-- 3. From the name, what do you suppose import Database.Blacktip.
-- Types is importing?
-- R: Datatypes related to a db.
...
-- R: Control.Concurrent.MVar , Filesystem.Path.CurrentOS , Control.Concurrent

-- b) Which import does FS.writeFile refer to?
-- R: Fileystem

-- c) Which import did forever come from?
-- R: Control.Concurrent
