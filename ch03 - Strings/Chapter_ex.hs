...
-- a) concat [[1, 2, 3], [4, 5, 6]]   -- yes [1,2,3,4,5,6]
-- b) ++ [1, 2, 3] [4, 5, 6]          -- no
-- c) (++) "hello" " world"           -- yes
-- d) ["hello" ++ " world]            -- yes
-- e) 4 !! "hello"                    -- no
...
-- main :: IO ()
-- main = print ()
-- Into the parentheses after print you’ll need to fill in your function
-- name rvrs plus the argument you’re applying rvrs to, in
-- this case “Curry is awesome.” That rvrs function plus its argument
-- are now the argument to print. It’s important to put them
